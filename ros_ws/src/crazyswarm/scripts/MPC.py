...
class MPC:
    def __init__(self, nx, nu, Q, R, Rdu, h, Ts, ca_method='cbf'):
        self.nx = nx
        self.nu = nu
    ...
    def compute_collision_avoidance_constraints(self, x, u):
        constraints_list = []
        if self.ca_method == 'cbf':
    ...
    def step(self, state):
        ...
        collision_avoidance_constraints = self.compute_collision_avoidance_constraints(x, u)
